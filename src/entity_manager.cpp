...
int main()
{
    ...
    const uint64_t oldConfigHash = getOldConfigHash();
    const uint64_t configHash = getConfigHash(configurationDirectory);

    if (fwVersionIsSame() && oldConfigHash == configHash)
    {
