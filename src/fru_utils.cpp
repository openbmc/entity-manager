    ...
    boost::container::flat_map<std::string, std::string>& result)
{
     ...
     * 0xEE 0xFF
     */
    std::vector<uint8_t> uuidCharOrder = {3, 2, 1,  0,  5,  4,  7,  6,
    ...
    if (areaOffset != 0)
    {
        ...
        {
            uint8_t uuidRecordLen = device[areaOffset + 2];
            ...
            areaOffset = areaOffset + uuidRecordLen + multiRecordHeaderLen;
        }
    }
}
