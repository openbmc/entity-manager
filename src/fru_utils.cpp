...
// Iterate FruArea Names and find offset/location and fields and size of the fru
// properties. returns true if fruArea location and fields are found. returns
// false if fruArea location not found and if any errors.
                                 ...
                                 struct FruArea& fruAreaParams)
{
    ...
    fruAreaParams.fruDataIter = fruAreaParams.start + offset;
    ...
    {
        if (fruAreaParams.fruDataIter < fruData.size())
        {
            fruAreaParams.length =
    ...
    fruAreaParams.fieldLoc = fruAreaParams.fruDataIter;
                     ...
                     std::vector<uint8_t>& restFRUAreaFieldsData)
{
    ...
    fruAreaParams.length = length;
    fruAreaParams.fieldLoc = fieldLoc;
    fruAreaParams.start = start;
    fruAreaParams.size = fruAreaSize;
    fruAreaParams.fruDataIter = fruDataIter;
    fruAreaParams.restFRUFieldsLoc = restFRUFieldsLoc;
    fruAreaParams.endOfFieldsLoc = endOfFieldsLoc;
