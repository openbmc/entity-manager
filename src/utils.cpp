...
bool findFiles(const fs::path& dirPath, const std::string& matchString,
               std::vector<fs::path>& foundPaths)
{
    static const std::vector<std::string> emptyPrefixes;
    return findFiles(dirPath, matchString, foundPaths, emptyPrefixes);
}
...
{
    static const std::vector<std::string> emptyPrefixes;
    return findFiles(dirPaths, matchString, foundPaths, emptyPrefixes);
}
