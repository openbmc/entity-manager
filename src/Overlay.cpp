...
constexpr const char* slotPathPrefix = "/xyz/openbmc_project/inventory/slot/";
constexpr const char* slotTypePrefix =
    "xyz.openbmc_project.Inventory.Item.PCIeSlot.SlotTypes.";

// Types of slots defined in PDI yaml
std::vector<std::string> slotTypes{
    "FullLength", "HalfLength", "LowProfile", "Mini", "M_2",
    "OEM",        "OCP3Small",  "OCP3Large",  "U_2",  "Unknown"};
             ...
             sdbusplus::asio::object_server& objServer)
{
         ...
         channelIndex++)
    {
        ...
        {
            // If this slot name is defined means this channel is a slot.
            isSlot = true;
        ...
        if (isSlot)
        {
            ...
            if (std::find(slotTypes.begin(), slotTypes.end(), slotTypeName) ==
                slotTypes.end())
            {
