...
static void pruneDevice(const nlohmann::json& systemConfiguration, const bool powerOff,
                        const bool scannedPowerOff, const std::string& name,
                       ...
                       nlohmann::json& systemConfiguration)
{
    ...
    timer.async_wait(
        [&systemConfiguration](const boost::system::error_code& ec) {
            ...
            {
                pruneDevice(systemConfiguration, powerOff, scannedPowerOff, name, device);
            }
...
static void pruneConfiguration(nlohmann::json& systemConfiguration,
                               sdbusplus::asio::object_server& objServer, bool powerOff,
        ...
        auto perfScan = std::make_shared<PerformScan>(
            ...
            [&systemConfiguration, &objServer, count, oldConfiguration,
             missingConfigurations]() {
                ...
                {
                    pruneConfiguration(systemConfiguration, objServer, powerOff, name, device);
                }
