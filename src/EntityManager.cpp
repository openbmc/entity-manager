               ...
               bool& foundProbe)
{
    ...
    for (auto& device : dbusObject)
    {
        ...
        if (deviceMatches)
        {
            ...
            foundMatch = true;
            // In a past version, the line commented below was here.  Because
            // deviceMatches is instantiated on lin 293, in this same context,
            // this line did nothing.  It isn't clear at this time what the
            // author was intending, so we'll leave this as a comment here for
            // the moment
