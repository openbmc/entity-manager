            ...
            for (const auto& busIterator : buses)
            {
                ...
                else if (busIterator.is_object())
                {
                    ...
                    if (busIterator.contains("addresses_white"))
                    {
                        ...
                        for (const auto& address : busIterator.at("addresses_white"))
                        {
                            std::string_view addressStr =
                                address.get<std::string>().substr(2);
                            size_t addressInt = 0;
                            std::from_chars(addressStr.data(),
                        ...
                        for (size_t addressInt = 0x03; addressInt <= 0x77;
                             ++addressInt)
                        {
                    ...
                    {
                        // No whitelist or explicit addresses, block all addresses
