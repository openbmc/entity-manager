    ...
    sdbusplus::asio::object_server& objServer)
{
    ...
    for (auto& devicemap : busMap)
    {
        ...
        {
            if (addFruObjectToDbus(device.second, dbusInterfaceMap,
                                   devicemap.first, device.first,
                                   unknownBusObjectCount, true, objServer,
                                   systemBus, devicemap.first, true))
            {
                std::cerr << "addFruObjectToDbus Failed for bus : "
                          << devicemap.first << std::endl;
                continue;
            }
        }
    }
