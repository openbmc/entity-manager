...
sdbusplus::async::task<void> ConfigProvider::initialize(
    AddedCallback addConfig, RemovedCallback removeConfig)
{
...
sdbusplus::async::task<void> ConfigProvider::getConfig(AddedCallback addConfig)
{
