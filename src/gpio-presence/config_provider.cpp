...
// NOLINTEND
{
    lg2::debug("Called InterfacesAdded handler");
    ...
    {
        lg2::error("Incomplete config found: {ERR}", "ERR", e.what());
    }
    co_return;
}
...
// NOLINTEND
{
    ...
    this->ifcRemoved = std::make_unique<sdbusplus::bus::match::match>(
        ...
        [&gpioPresence](sdbusplus::message::message& msg) {
            ...
            lg2::debug("interfaces removed handler called");
    ...
    lg2::debug("Initialization completed");
