...
// std::nullopt if Type is missing or not a string. Callers must not create
// a D-Bus object for a configuration whose Type could not be resolved, and
// should log why using the caller's own config name/id.
