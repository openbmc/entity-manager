    ...
    std::map<std::string, std::string>& newBoards)
{
    ...
    {
        boardType =
            dbus_regex::sanitizeMember(findBoardType->get<std::string>());
    }
    else
    {
    ...
    const std::string& boardType)
{
    ...
    {
        itemType = dbus_regex::sanitizePath(findType->get<std::string>());
    }

    const std::string itemName =
        dbus_regex::sanitizeMember(findName->get<std::string>());
