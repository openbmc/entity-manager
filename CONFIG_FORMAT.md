...
```json5
{
  ...
  "TestKey": "TestValue" // Single-line comment (end of content)
}
```
...
- Comments will get inserted back into the file in the line they came from. If
  keys are resorted or the number of lines change, all bets for correctness are
  off.
