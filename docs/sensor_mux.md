...
a plug-in card's sensor values on dbus. When required, a MUX such as PCA9548
can be used to connect sensors across multiple channels.
...
notified that hardware monitoring temperature and ADC sensors are available.
