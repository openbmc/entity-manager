...
inline size_t unknownBusObjectCount = 0;

constexpr bool debug = false;
constexpr size_t maxFruSize = 512;
constexpr size_t fruBlockSize = 8;

constexpr size_t minUpdatePropReqLen = 1;
constexpr size_t maxUpdatePropReqLen = 63;

const std::string fruDbusObject = "/xyz/openbmc_project/FruDevice";
const std::string fruDbusIface = "xyz.openbmc_project.FruDeviceManager";
