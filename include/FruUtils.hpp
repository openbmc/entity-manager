...
{
public:
  FRUReader(ReadBlockFunc readFunc) : impl(CachingReader{std::move(readFunc), CachingReader::Cache(), std::nullopt})
  {}
  FRUReader(FRUReader& inner, size_t offset) : impl(OffsetReader{inner, offset})
  {}
