...
{
public:
  // The ::read() operation here is analogous to ReadBlockFunc, but abstracts
  // away SMBus block size limitations (all derived classes must meet this
  // requirement with their implementations of it).
