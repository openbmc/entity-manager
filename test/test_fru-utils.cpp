...
TEST(FormatIPMIFRUTest, CommonAreaHasZeroLength)
{
    const auto malformedFru = std::to_array<uint8_t>({
        ...
        0x19, 0x0c, 0x41, 0x72, 0x74, 0x65, // remaining of Product area byte 1
        0x73, 0x79, 0x6e, 0x20, 0x20, 0x20, 0x20, 0x20, // Product area byte 2
        0x24, 0x43, 0x52, 0x50, 0x53, 0x3a, 0x20, 0x43, // Product area byte 3
        0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x20, 0x52, 0x65, // Product area byte 4
        0x64, 0x75, 0x6e, 0x64, 0x61, 0x6e, 0x74, 0x20, // Product area byte 5
        0x50, 0x6f, 0x77, 0x65, 0x72, 0x20, 0x53, 0x75, // Product area byte 6
        0x70, 0x70, 0x6c, 0x79, 0x00, 0x10, 0x43, 0x53, // Product area byte 7
        0x55, 0x32, 0x30, 0x30, 0x30, 0x41, 0x50, 0x2d, // Product area byte 8
        0x33, 0x2d, 0x31, 0x30, 0x30, 0x20, 0x10, 0x52, // Product area byte 9
        0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x20, 0x2d, // Product area byte 10
        0x30, 0x30, 0x32, 0x31, 0x00, 0x20, 0x20, 0x0e, // Product area byte 11
        0x4e, 0x33, 0x30, 0x30, 0x31, 0x35, 0x30, 0x30, // Product area byte 12
        0x35, 0x52, 0x4a, 0x57, 0x5a, 0x20, 0xc1, 0xd1  // Product area byte 13
    });
    std::flat_map<std::string, std::string, std::less<>> result;
...
TEST(FormatIPMIFRUTest, CommonAreaHasEndOffsetExceedFRUSize)
{
    const auto malformedFru = std::to_array<uint8_t>({
        ...
        0x30, 0x30, 0x32, 0x31, 0x00, 0x20, 0x20, 0x0e, // Product area byte 11
        0x4e, 0x33, 0x30, 0x30, 0x31, 0x35, 0x30, 0x30, // Product area byte 12
        0x35, 0x52, 0x4a, 0x57, 0x5a, 0x20, 0xc1, 0xa1  // Product area byte 13
    });
    std::flat_map<std::string, std::string, std::less<>> result;
    ASSERT_EQ(formatIPMIFRU(malformedFru, result), resCodes::resErr);
}
