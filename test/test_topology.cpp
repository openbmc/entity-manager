...
const Association subPowerAssoc = std::make_tuple("powered_by", "powering",
                                                  superpowerPath);
...
{
    const nlohmann::json subchassisMissingPoweredByType =
    ...
    topo.addBoard(superchassisPath, "Chassis", "BoardB", subpowerExposesItem);
...
TEST(Topology, NoNewBoards)
{
    ...
    topo.addBoard(superchassisPath, "Chassis", "BoardC",
                  superchassisExposesItem);
    topo.addBoard(superpowerPath, "Chassis", "BoardD", superpowerExposesItem);
...
TEST(Topology, OneNewPoweredBoardAndOneNewChassisBoard)
{
    ...
    topo.addBoard(superchassisPath, "Chassis", "BoardE",
                  superchassisExposesItem);
    topo.addBoard(superpowerPath, "Chassis", "BoardF", superpowerExposesItem);
...
{
    const Association subPowerAssoc2 = std::make_tuple("powered_by", "powering",
                                                       superpowerPath + "2");
